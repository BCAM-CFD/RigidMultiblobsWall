...
class ReadInput(object):
  ...
  def __init__(self, entries):
    ...
    self.plot_velocity_line = np.fromstring(self.options.get('plot_velocity_line') or 'None', sep=' ')
    self.plot_velocity_field_sphere = np.fromstring(self.options.get('plot_velocity_field_sphere') or 'None', sep=' ', dtype=int)

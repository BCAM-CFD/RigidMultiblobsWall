...
def gmres(A, b, x0=None, tol=1e-05, restart=None, maxiter=None, xtype=None, M=None, callback=None, restrt=None, atol=0, PC_side='right'):
  '''
  ...
  (y, info) = scspla.gmres(APinv_partial_LO, b, x0=x0, tol=tol, maxiter=maxiter, restart=restart, atol=atol, callback=callback) 
